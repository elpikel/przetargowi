defmodule Przetargowi.Alerts.AlertEmail do
  @moduledoc """
  ...
  def compose(email, notices, tender_category) do
    ...
    |> subject("Nowe przetargi: #{tender_category} - Przetargowi")
    ...
    <html lang="pl">
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>
              © #{DateTime.utc_now().year} Przetargowi. Wszelkie prawa zastrzeżone.<br />
              <a href="mailto:kontakt@przetargowi.pl">kontakt@przetargowi.pl</a>
            </p>
            <p class="unsubscribe">
              Aby zmienić preferencje powiadomień, <a href="https://przetargowi.pl/login">zaloguj się do swojego konta</a>.
            </p>
          </div>
        </div>
      </body>
  ...
  defp notice_html(notice) do
    ...
    tender_link = "https://przetargowi.pl/przetargi/#{notice.object_id}"
  ...
  defp alert_email_text(notices, tender_category) do
    ...
    Aby zmienić preferencje powiadomień, zaloguj się do swojego konta: https://przetargowi.pl/login
    """
  end
