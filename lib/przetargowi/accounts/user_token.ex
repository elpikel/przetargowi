defmodule Przetargowi.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Przetargowi.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Przetargowi.Accounts.User
  ...
  The given token is valid if it matches its hashed counterpart in the
  database and if it has not expired (after 7 days).
  """
