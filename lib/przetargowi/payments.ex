defmodule Przetargowi.Payments do
  @moduledoc """
  ...
  alias Przetargowi.Payments.Subscription
  ...
  defp stripe_client do
    Application.get_env(:przetargowi, :stripe_client, Przetargowi.Stripe.Client)
  end
  ...
  defp create_failed_transaction(subscription, event) do
    attrs = %{
      ...
      currency: subscription.currency,
      stripe_description: "Przetargowi Premium - failed renewal"
    }
